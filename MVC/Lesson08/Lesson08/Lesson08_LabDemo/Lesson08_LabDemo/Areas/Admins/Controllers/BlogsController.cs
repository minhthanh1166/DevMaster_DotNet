...
namespace Lesson08_LabDemo.Areas.Admins.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Status,VỉewCount,CreateDate,Image,Description")] Blog blog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Status,VỉewCount,CreateDate,Image,Description")] Blog blog)
        {
            if (id != blog.Id)
            {
                return NotFound();
