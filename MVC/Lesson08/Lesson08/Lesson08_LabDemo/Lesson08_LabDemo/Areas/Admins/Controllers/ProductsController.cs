...
namespace Lesson08_LabDemo.Areas.Admins.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Price,SalePrice,Status,Description,CreateDate,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Price,SalePrice,Status,Description,CreateDate,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
