...
namespace Lesson08_LabDemo.Areas.Admins.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Image,Username,Password,Facebook,CreateDate,Status,Address,Phone,Gender")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Image,Username,Password,Facebook,CreateDate,Status,Address,Phone,Gender")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
