...
namespace Lesson08_LabDemo.Areas.Admins.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Address,Note,CreateDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,Address,Note,CreateDate")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
