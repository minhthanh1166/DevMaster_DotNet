...
namespace Lesson08_LabDemo.Areas.Admins.Controllers
{
    ...
    public class BannersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Status,Prioty,Image,Description,CreateDate")] Banner banner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Status,Prioty,Image,Description,CreateDate")] Banner banner)
        {
            if (id != banner.Id)
            {
                return NotFound();
