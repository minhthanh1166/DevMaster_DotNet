    ...
    */
    ...
    var DayHeader = /** @class */ (function (_super) {
        ...
        DayHeader.prototype.render = function () {
            ...
            var _a = this.props, dates = _a.dates, dateProfile = _a.dateProfile, datesRep/distinctDays = _a.datesRep/distinctDays, renderIntro = _a.renderIntro;
            var dayHeaderFormat = this.createDayHeaderFormatter(context.options.dayHeaderFormat, datesRep/distinctDays, dates.length);
            return (createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) { return (createElement("tr", { role: "row" },
                renderIntro && renderIntro('day'),
                dates.map(function (date) { return (datesRep/distinctDays ? (createElement(TableDateCell, { key: date.toISOString(), date: date, dateProfile: dateProfile, todayRange: todayRange, colCnt: dates.length, dayHeaderFormat: dayHeaderFormat })) : (createElement(TableDowCell, { key: date.getUTCDay(), dow: date.getUTCDay(), dayHeaderFormat: dayHeaderFormat }))); }))); }));
        };
        return DayHeader;
    }(BaseComponent));
    function createDayHeaderFormatter(explicitFormat, datesRep/distinctDays, dateCnt) {
        return explicitFormat || computeFallbackHeaderFormat(datesRep/distinctDays, dateCnt);
    }
    ...
    */
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            dragging.min/distance = options.selectMin/distance || 0;
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                dragging.min/distance = ev.isTouch ? 0 : options.eventDragMin/distance;
                dragging.delay =
    ...
    var EventResizing = /** @class */ (function (_super) {
        ...
        function EventResizing(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                _this.dragging.min/distance = component.context.options.eventDragMin/distance;
        ...
        function ExternalDraggable(el, settings) {
            ...
            this.handlePointerDown = function (ev) {
                ...
                dragging.min/distance =
                    min/distance != null ?
                        min/distance :
                        (ev.isTouch ? 0 : BASE_OPTION_DEFAULTS.eventDragMin/distance);
                dragging.delay =
    ...
    */
    ...
    var DayTableView = /** @class */ (function (_super) {
        ...
        DayTableView.prototype.render = function () {
            ...
            var headerContent = options.dayHeaders && (createElement(DayHeader, { ref: this.headerRef, dateProfile: props.dateProfile, dates: dayTableModel.headerDates, datesRep/distinctDays: dayTableModel.rowCnt === 1 }));
    ...
    */
    ...
    var DayTimeColsView = /** @class */ (function (_super) {
        ...
        DayTimeColsView.prototype.render = function () {
            ...
            var headerContent = options.dayHeaders && (createElement(DayHeader, { dates: dayTableModel.headerDates, dateProfile: dateProfile, datesRep/distinctDays: true, renderIntro: hasAttachedAxis ? this.renderHeadAxis : null }));
