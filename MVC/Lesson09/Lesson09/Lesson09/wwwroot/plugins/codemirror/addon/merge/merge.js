...
(function(mod) {
  ...
  function syncScroll(dv, toOrig) {
    ...
    if (dv.mv.options.connect == "align") {
      ...
      } else if ((bot/dist = sInfo.height - sInfo.clientHeight - sInfo.top) < halfScreen) {
        var otherInfo = other.getScrollInfo();
        var bot/distOther = otherInfo.height - otherInfo.clientHeight - targetPos;
        if (bot/distOther > bot/dist && (mix = bot/dist / halfScreen) < 1)
          targetPos = targetPos * mix + (otherInfo.height - otherInfo.clientHeight - bot/dist) * (1 - mix);
      }
    }
