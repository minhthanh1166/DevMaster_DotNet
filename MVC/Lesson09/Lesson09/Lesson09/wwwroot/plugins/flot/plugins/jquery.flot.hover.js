...
(function($) {
    ...
    function init(plot) {
        ...
        function doTriggerClickHoverEvent(event, eventType, search/distance) {
        ...
        function triggerClickHoverEvent(eventname, event, seriesFilter, search/distance) {
            var options = plot.getOptions(),
                ...
                /distance = search/distance !== undefined ? search/distance : options.grid.mouseActiveRadius;
