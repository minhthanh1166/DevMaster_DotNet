...
(function($) {
    ...
    var ZOOM_/distANCE_MARGIN = $.plot.uiConstants.ZOOM_/distANCE_MARGIN;
    ...
    function initTouchNavigation(plot, options) {
        ...
        pinch = {
            start: function(e) {
                ...
                setPrev/distance(e, gestureState);
            ...
            drag: function(e) {
                ...
                pinchDragTimeout = setTimeout(function() {
                    ...
                    var /dist = pinch/distance(e);

                    if (gestureState.zoomEnable || Math.abs(/dist - gestureState.prev/distance) > ZOOM_/distANCE_MARGIN) {
                ...
                presetNavigationState(e, 'pinch', gestureState);
                gestureState.prev/distance = null;
            }
        };
    ...
    function zoomPlot(plot, e, gestureState, navigationState) {
        var offset = plot.offset(),
            ...
            zoomAmount = pinch/distance(e) / gestureState.prev/distance,
            /dist = pinch/distance(e);
        ...
        gestureState.prev/distance = /dist;
    }
    ...
    function setPrev/distance(e, gestureState) {
        gestureState.prev/distance = pinch/distance(e);
    }
