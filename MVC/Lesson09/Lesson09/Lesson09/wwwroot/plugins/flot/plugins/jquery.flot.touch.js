...
(function($) {
    ...
    function initTouchNavigation(plot, options) {
        var gestureState = {
            ...
            max/distanceBetweenTaps = 20,
            maxIntervalBetweenTaps = 500,
            maxLongTap/distance = 20,
        ...
        var longTap = {
            ...
            isLongTap: function(e) {
                ...
                if (tapDuration >= minLongTapDuration && !gestureState.interceptedLongTap) {
                    if (/distance(gestureState.currentTapStart.x, gestureState.currentTapStart.y, gestureState.currentTapEnd.x, gestureState.currentTapEnd.y) < maxLongTap/distance) {
        ...
        function isDoubleTap(e) {
            ...
            if (intervalBetweenTaps >= 0 && intervalBetweenTaps < maxIntervalBetweenTaps) {
                if (/distance(gestureState.prevTap.x, gestureState.prevTap.y, gestureState.currentTap.x, gestureState.currentTap.y) < max/distanceBetweenTaps) {
